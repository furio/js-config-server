...
JsonEncryptedFieldsFilter.prototype.filterData = function(rawData) {
    ...
    return _exploreJson(rawData, {}, decryptFunc());
};
...
var _exploreJson = function(jsonObject, endObject, decryptFunc) {
    for(var key in jsonObject) {
        ...
        } else if (typeof jsonObject[key] == 'array') {
            endObject[key] = jsonObject[key].map(function (el) {
                return _exploreJson(el, {}, decryptFunc);
            });
        } else {
