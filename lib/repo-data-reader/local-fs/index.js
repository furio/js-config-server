...
var debugLog = require('debug')('lib-repo-single-data-reader:local-fs');
...
var LocalRepositoryData = module.exports = function LocalRepository(options) {
    ...
    this.defaultExt = options.defaultExt || EXTCONF;
    this.realBaseUri = fs.realpathSync(this.baseUri, "utf8");
};

LocalRepositoryData.prototype.getConfigData = function(appName, appEnv){
    return realPath(path.resolve(this.realBaseUri, "./" + appName, "./" + appEnv + "." + this.defaultExt), "utf8")
        .bind(this)
